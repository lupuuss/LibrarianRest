package pl.lodz.pas.librarianrest.producer;

import pl.lodz.pas.librarianrest.producer.annotations.BooksRepositoryInitializer;
...
import pl.lodz.pas.librarianrest.repository.books.data.*;
